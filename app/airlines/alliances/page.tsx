...
const alliances = [
  {
    ...
    airlines: [
      ...
      },
      {
        ...
        logo: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=100&auto=format&fit=crop",
...
export default function AirlineAlliancesPage() {
  return (
    <div className="container px-4 py-8 md:px-6 md:py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Airline Alliances</h1>
        <p className="text-muted-foreground max-w-3xl">
          Airline alliances are partnerships between airlines that allow them to extend their network and provide
          seamless travel experiences across multiple carriers. Learn about the three major global airline alliances and
          their benefits for travelers.
        </p>
      </div>
        ...
        <TabsContent value="overview" className="mt-6">
          <div className="grid gap-6 md:grid-cols-3">
            {alliances.map((alliance) => (
              <Card key={alliance.id} id={alliance.id} className="overflow-hidden">
                <div className="p-6">
                  ...
                  <CardTitle className="text-xl mb-2">{alliance.name}</CardTitle>
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm mb-4">
                    <div>
                      <span className="text-muted-foreground">Founded:</span>
                      <span className="ml-1 font-medium">{alliance.founded}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Members:</span>
                      <span className="ml-1 font-medium">{alliance.members}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Destinations:</span>
                      <span className="ml-1 font-medium">{alliance.destinations}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Countries:</span>
                      <span className="ml-1 font-medium">{alliance.countries}</span>
                    </div>
                  </div>
                  <p className="text-sm text-muted-foreground line-clamp-3 mb-4">{alliance.description}</p>
                </div>
                <div className="bg-muted p-4 flex justify-between items-center">
                  <span className="text-sm font-medium">View member airlines</span>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => document.getElementById(alliance.id)?.scrollIntoView({ behavior: "smooth" })}
                  >
                    Learn More
                  </Button>
                </div>
          ...
          <div className="mt-12 bg-sky-50 rounded-xl p-6 md:p-8">
            <div className="grid gap-6 md:grid-cols-2 items-center">
              <div className="space-y-4">
                <h2 className="text-2xl font-bold">Benefits of Airline Alliances</h2>
                <p className="text-muted-foreground">
                  Airline alliances offer numerous benefits for travelers, from seamless connections to shared frequent
                  flyer programs. Here are some key advantages:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>Seamless travel across multiple airlines with a single ticket</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>Earn and redeem miles across all member airlines</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>Priority check-in, boarding, and baggage handling</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
          ...
          <TabsContent key={alliance.id} value={alliance.id} className="mt-6">
            <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
              <div className="space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-sm text-muted-foreground">Headquarters: {alliance.headquarters}</span>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-3">About {alliance.name}</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                    ...
                    <Card>
                      <CardHeader className="p-4 pb-2">
                        <CardTitle className="text-sm">Member Airlines</CardTitle>
                      </CardHeader>
                      <CardContent className="p-4 pt-0">
                    ...
                    <Card>
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-2xl font-bold">{alliance.destinations}</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader className="p-4 pb-2">
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-2xl font-bold">{alliance.countries}</p>
                      </CardContent>
                    </Card>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Member Airlines</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <Card className="bg-sky-50 border-dashed border-sky-200">
                      <CardContent className="p-4 flex items-center justify-center h-full">
                        <Button variant="ghost" className="text-sky-700" asChild>
                          <Link href="/airlines">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Alliance Benefits</h3>
              ...
              <div className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Earn and redeem miles across all {alliance.name} member airlines</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <h4 className="font-medium">Elite Status Recognition</h4>
                      <p className="text-sm text-muted-foreground">
                        Your elite status with one member airline is recognized across the entire alliance, giving you
                        consistent benefits wherever you fly.
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-medium">Miles Earning & Redemption</h4>
                      <p className="text-sm text-muted-foreground">
                        Earn miles when flying on any member airline and redeem them for flights, upgrades, or other
                        rewards across the alliance.
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="font-medium">Lounge Access</h4>
                      <p className="text-sm text-muted-foreground">
                        Elite members enjoy access to lounges operated by all member airlines when traveling
                        internationally.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Explore the world with special fares</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      {alliance.name} offers special Round-the-World tickets that allow you to travel across multiple
                      continents using member airlines. These tickets offer flexibility and value for global travelers.
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      Visit the official {alliance.name} website for more information about member airlines, benefits,
                      and services.
                    </p>
                  </CardContent>
                  <CardFooter>
        ...
        <div className="bg-sky-50 rounded-xl p-6 md:p-8">
          <div className="grid gap-6 md:grid-cols-2 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Not sure which alliance is right for you? Compare the benefits and coverage of each alliance to find the
                best fit for your travel needs.
              </p>
              <Button asChild>
                <Link href="/airlines/alliance-comparison">Compare Alliances</Link>
              </Button>
            </div>
