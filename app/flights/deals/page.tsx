...
const deals = [
  {
    ...
    terms:
      "Blackout dates may apply. Offer subject to availability. Taxes and fees not included.",
  },
  {
    id: "asia-explorer",
    title: "Asia Explorer",
    ...
    terms:
      "Minimum stay of 7 days required. Changes permitted for a fee. Offer valid for direct bookings only.",
  },
  {
    ...
    terms:
      "Advance purchase of 21 days required. Saturday night stay required for lowest fares.",
  },
  {
    id: "european-getaway",
    ...
    terms:
      "Discount applies to base fare only. Taxes and surcharges apply. No changes or cancellations permitted.",
  },
  {
    id: "london-calling",
    ...
    terms:
      "Valid for travel Monday through Thursday. Weekend surcharges apply. Minimum stay of 3 nights required.",
  },
  {
    id: "pacific-routes",
    ...
    terms:
      "Seasonal surcharges may apply. Discount valid for direct flights only. Stopovers not permitted.",
  },
  {
    id: "paris-special",
    title: "Paris Special",
  ...
  },
  {
    ...
    terms:
      "14-day advance purchase required. Discount not valid on basic economy fares. Subject to availability.",
  },
];
    ...
    <div className="container px-4 py-8 md:px-6 md:py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground max-w-3xl">
          Take advantage of special offers and discounts from our airline
          partners. Browse our exclusive deals below or search for specific
          destinations.
        </p>
      </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Subscribe to our newsletter to receive personalized deal alerts
                for your favorite destinations and airlines.
              </p>
      ...
      <section className="mt-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                For the best deals, book your flights 2-3 months in advance for
                international travel and 1-2 months for domestic flights.
                Tuesday and Wednesday are often the cheapest days to book.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Being flexible with your travel dates can save you money. Use
                our flexible dates search to find the cheapest days to fly to
                your destination.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Many of our deals are limited-time offers. When you find a great
                deal, book it quickly as prices can change and promotions can
                end without notice.
              </p>
            </CardContent>
          </Card>
